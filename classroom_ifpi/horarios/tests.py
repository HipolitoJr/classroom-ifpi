...
from horarios.models import Horario, DeclaracaoAusencia


class TesteDeclaracaoAusencia(TestCase):
    ...
    def setUp(self):
        ...
        self.ausencia = mommy.make(DeclaracaoAusencia, justificativa = 'justificativa teste', professor = self.professor, turma = self.turma, data_falta=datetime.now(), data_declaracao = datetime.now(), horario = self.horario)

    def teste_declaracao_ausencia_creation(self):
        self.assertTrue(isinstance(self.ausencia , DeclaracaoAusencia))
